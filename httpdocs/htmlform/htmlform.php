...
<html>
    ...
    <head>
        ...
        <style>
            ...
            #element_518104c63a5a6 {
                width:180px;
            }
            .fieldlabel_block {
                width:152px;
            }
            #element_5188fd82e9a9c {
                height:80px;
            }
            #element_5181050e6794c {
                width:180px;
            }
            #element_51810719311ca {
                width:180px;
            }
            #element_518107f9c92b4 {
                width:180px;
            }
            #element_5181059a903c5 {
                width:120px;
            }
            #element_518109e32c206 {
                width:150px;
            }
            #element_51810989a8cdf {
                width:120px;
            }
    ...
    <body>
        ...
        <div>
            <form id="htmlform" style="width: 80%;" method="post" enctype="multipart/form-data" action="process.php" class="validform" onSubmit="return (validateCaptcha());">
                <fieldset class="main_fieldset">
                            ...
                            <ol>
                                    ...
                                    <div class='field_block'>
                                        <div class="vf__required">
                                            <div class="fieldlabel_block">
                                                <label>First Name<span class="asterisk_required">*</span>
                                ...
                                <li>
                                    <div class='field_block'>
                                        <div class="vf__required">
                                            <div class="fieldlabel_block">
                                                <label>Surname<span class="asterisk_required">*</span>
                                ...
                                <li>
                                    <div class='field_block'>
                                        <div class="vf__required">
                                            <div class="fieldlabel_block">
                                                <label>Address<span class="asterisk_required">*</span>
                                ...
                                <li>
                                    <div class='field_block'>
                                        <div class="vf__optional">
                                            <div class="fieldlabel_block">
                                                <label data-tooltip="enter your post code here... example se10 9pe"><strong>Post Code</strong></label>
                                            </div>
                                            <div class="fielddesc_block">
                                ...
                                <li>
                                    <div class='field_block'>
                                        <div class="vf__required">
                                            <div class="fieldlabel_block">
                                                <label data-tooltip="click on the calendar icon and choose date">Date of Birth<span class="asterisk_required">*</span>
                                ...
                                <li>
                                    <div class='field_block'>
                                        <div class="vf__required">
                                            <div class="fieldlabel_block">
                                                <label data-tooltip="enter your email in the format xxx@xxx.xxx">Email<span class="asterisk_required">*</span>
                                ...
                                <li>
                                    <div class='field_block'>
                                        <div class="vf__required">
                                            <div class="fieldlabel_block">
                                                <label>Phone Number<span class="asterisk_required">*</span>
                                ...
                                <li>
                                    <div class='field_block'>
                                        <div class="vf__optional">
                                            <div class="fieldlabel_block">
                                                <label data-tooltip="Leave blank if no CV attached">Attach your CV</label>
                                            </div>
                                            <div class="fielddesc_block">
                                                <input type="file" name="fileAttach[]" class="multi vf__text" accept="pdf|doc|docx" maxlength="2" data-label="Attach your CV" />
                                            </div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <fieldset>
                            ...
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Have you got access to two learners undergoing a vocational course?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Have you got any assessing experience?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Do you know what is Guided Learning Hours (GLH)?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Do you know the difference between the NCF and QCF framework?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Do you know what is cross referencing?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Do you know what is a standardisation meeting?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Can you name legislation and code of practice that affects the assessing role?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Have you ever worked with an action plan framework?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Do you have knowledge of the different assessment methods?<span class="asterisk_required">*</span>
                        ...
                        <li>
                            <div class='field_block'>
                                <div class="vf__required">
                                    <div class="fieldlabel_block_radio">
                                        <label>Do you know the roles of both the internal and external verifier?<span class="asterisk_required">*</span>
                            ...
                            <div class='field_block'>
                                <div class="vf__optional">
                                    <div class="fieldlabel_block" style="width: 40%;">
                                        <label data-tooltip="Please write about 300 words">What skills have you got which you think will make you a good assessor? Please write about 400 words! This is also an assessment of your literacy skills! You will need to state here if you want us to facilitate learners for you?</label>
                                    </div>
                                    <div class="fielddesc_block">
                                        <textarea name="cover_letter" style="width: 90%; position: relative; display: inline; float: left;" cols="90" rows="12" data-label="What skills have you got which you think will make you a good assessor? Please write about 300 words! This is also an assessment of your literacy skills! You will need to state here if you want us to facilitate learners for you?"
                                        id="element_5188fd82e9a9c" class="vf__text"></textarea>
                                    </div>
                                </div>
                            </div>
                        </li>
                    ...
                    <li>
                        <div class='container_recaptcha'>
                            <div class='recaptcha'>
                                <div class='vf__recaptcha'>Recaptcha Validation: <span style="color: red;">Pls type in the displayed text below</span> 
                                    <script type="text/javascript" src="http://www.google.com/recaptcha/api/challenge?k=6LcmuuASAAAAAAtiHjxufW8yFHBw_xy4-TpfBmjY"></script>
                                    <noscript>
                                        <iframe src="http://www.google.com/recaptcha/api/noscript?k=6LcmuuASAAAAAAtiHjxufW8yFHBw_xy4-TpfBmjY" height="300" width="500" style="border:0px"></iframe>
                                        <br/>
            ...
            <div class="validating_space" id="validating_space" style="width: 100%;"></div>
            <script type="text/javascript">
                // <![CDATA[
